    ...
    public class SaveAndRestore : SerializableDataExtensionBase
    {
        ...
        public override void OnSaveData()
        {
            if (Loader.CurrentLoadMode == LoadMode.LoadGame || Loader.CurrentLoadMode == LoadMode.NewGame)
            {
                ...
                MainDataStore.saveData = new byte[512];
                gather_saveData();
                SaveAndRestore._serializableData.SaveData("RushHourPublicTransportHelper MainDataStore", MainDataStore.saveData);
            }
        }
        ...
        public override void OnLoadData()
        {
            ...
            MainDataStore.saveData = SaveAndRestore._serializableData.LoadData("RushHourPublicTransportHelper MainDataStore");
            if (MainDataStore.saveData == null)
            {
                DebugLog.LogToFileOnly("no RushHourPublicTransportHelper MainDataStore save data, please check");
            }
            else
            {
                MainDataStore.load();
